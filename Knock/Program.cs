...
namespace Knock
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length >= 3 && (IPAddress.TryParse(args[1], out address) || IPAddress.TryParse(System.Net.Dns.GetHostEntry(args[1]).AddressList[0].ToString(), out address)))
            {
            ...
            else
            {
                ...
                Console.WriteLine("example: knock.exe TCP example.com 123 456 789");
            }
        }
    }
}
